...
//	GET : /api/board
	@GetMapping
	public ResponseEntity<List<ProfileVo>> getAllItems() {
		List<ProfileVo> items = 
				profileService.selectAllItems();
...
//	POST : /api/board -> 새로운 항목 생성
	@PostMapping
	public ResponseEntity<ProfileVo> createItem(@RequestBody ProfileVo item) {
		ProfileVo savedItem = profileService.insertItem(item);
